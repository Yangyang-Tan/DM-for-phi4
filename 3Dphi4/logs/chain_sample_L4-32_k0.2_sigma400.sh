#!/bin/bash
# Wait for L4-32 k=0.2 sigma=400 training (PID $TRAIN_PID), then sample L=64 with linear+log on cuda:3.
set -u
TRAIN_PID=1858307
DEV=cuda:3
K=0.2
RUN_DIR=runs/phi4_3d_Lmulti4-8-16-32_k${K}_l0.9_ncsnpp_sigma400
